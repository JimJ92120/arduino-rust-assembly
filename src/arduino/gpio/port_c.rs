...
impl Port for PortC {
    const PORT_ADDRESS: *mut u8 = (REGISTER_OFFSET | 0x08) as *mut u8;
    const DDR_ADDRESS: *mut u8 = (REGISTER_OFFSET | 0x07) as *mut u8;
    const PIN_ADDRESS: *mut u8 = (REGISTER_OFFSET | 0x06) as *mut u8;
}
